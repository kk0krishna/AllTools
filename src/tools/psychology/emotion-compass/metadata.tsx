...
export const emotionCompassEntry: ToolEntry = {
  ...
  content: () => (
    <>
      ...
      <div className="flex flex-col items-center justify-center mb-12 mt-6 p-8 bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl border border-primary/20 no-print shadow-sm text-center">
        <h3 className="text-xl font-bold mb-3 text-foreground mt-0">Ready to map your emotions?</h3>
        <p className="text-muted-foreground mb-6 text-sm max-w-sm">Jump back up to the interactive compass and start exploring your inner world.</p>
        <a href="#emotion-wheel" className="inline-flex items-center justify-center rounded-full bg-primary !text-white hover:bg-primary/90 h-12 px-10 shadow-lg font-bold hover:scale-105 transition-all duration-300 hover:shadow-primary/30 no-underline">
          <svg className="w-5 h-5 mr-2 animate-bounce text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>
          <span className="text-white">Explore the Compass</span>
        </a>
      </div>
    </>
  ),
