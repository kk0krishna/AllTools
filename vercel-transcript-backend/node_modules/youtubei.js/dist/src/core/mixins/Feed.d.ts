...
import { type Memo, type ObservedArray } from '../../parser/helpers.js';
...
export default class Feed<T extends IParsedResponse = IParsedResponse> {
     ...
     */
    static getVideosFromMemo(memo: Memo): ObservedArray<CompactVideo | GridVideo | LockupView | PlaylistPanelVideo | PlaylistVideo | ReelItem | ShortsLockupView | Video | WatchCardCompactVideo>;
    /**
     * Get all playlists on a given page via memo
     */
    static getPlaylistsFromMemo(memo: Memo): ObservedArray<GridPlaylist | GridShow | LockupView | Playlist>;
    /**
     ...
     */
    get playlists(): ObservedArray<GridPlaylist | GridShow | LockupView | Playlist>;
    get memo(): Memo;
    /**
