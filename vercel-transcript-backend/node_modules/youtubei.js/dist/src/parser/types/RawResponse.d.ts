...
type IYoutubeApiInnertubeMainAppHotConfig = {
    ...
    youtubeAssistantAudioEncoding?: 'YOUTUBE_ASSISTANT_AUDIO_ENCODING_UNKNOWN' | 'YOUTUBE_ASSISTANT_AUDIO_ENCODING_LINEAR16' | 'YOUTUBE_ASSISTANT_AUDIO_ENCODING_AMR_WB' | 'YOUTUBE_ASSISTANT_AUDIO_ENCODING_OGG_OPUS' | 'YOUTUBE_ASSISTANT_AUDIO_ENCODING_FLAC';
    youtubeAssistantEnablePermissionVeLogging?: boolean;
    youtubeAssistantTipType?: 'YOUTUBE_ASSISTANT_VOICE_TIP_TYPE_UNKNOWN' | 'YOUTUBE_ASSISTANT_VOICE_TIP_TYPE_CURATED' | 'YOUTUBE_ASSISTANT_VOICE_TIP_TYPE_P13N_PROFILE_TOPIC_ENTITY' | 'YOUTUBE_ASSISTANT_VOICE_TIP_TYPE_P13N_PROFILE_MUSIC_ENTITY' | 'YOUTUBE_ASSISTANT_VOICE_TIP_TYPE_P13N_PROFILE_GENERAL_ENTITY' | 'YOUTUBE_ASSISTANT_VOICE_TIP_TYPE_QUERY_SUGGESTION' | 'YOUTUBE_ASSISTANT_VOICE_TIP_TYPE_ZERO_PREFIX_QUERY_SUGGESTION' | 'YOUTUBE_ASSISTANT_VOICE_TIP_TYPE_ZERO_PREFIX_AND_MUSIC_ENTITY';
...
type IYoutubeApiInnertubeServiceTrackingParams = {
    params?: Array<IYoutubeApiInnertubeKeyValuePair>;
    service?: 'SERVICE_UNKNOWN' | 'CSI' | 'GFEEDBACK' | 'BREAKPAD' | 'GUIDED_HELP' | 'GOOGLE_HELP' | 'ECATCHER' | 'SUGGEST' | 'LISTNR';
};
...
type IYoutubeApiInnertubeCpnInfo = {
    cpn?: string;
    cpnSource?: 'CPN_SOURCE_TYPE_UNKNOWN' | 'CPN_SOURCE_TYPE_CLIENT' | 'CPN_SOURCE_TYPE_WATCH_SERVER';
};
...
type IYoutubeApiInnertubeColorInfo = {
    dynamicMetadata?: 'DYNAMIC_METADATA_UNSPECIFIED' | 'DYNAMIC_METADATA_SMPTE2094_40';
    matrixCoefficients?: 'COLOR_MATRIX_COEFFICIENTS_UNKNOWN' | 'COLOR_MATRIX_COEFFICIENTS_BT709' | 'COLOR_MATRIX_COEFFICIENTS_UNSPECIFIED' | 'COLOR_MATRIX_COEFFICIENTS_BT2020_NCL';
    primaries?: 'COLOR_PRIMARIES_UNKNOWN' | 'COLOR_PRIMARIES_BT709' | 'COLOR_PRIMARIES_UNSPECIFIED' | 'COLOR_PRIMARIES_BT2020';
    transferCharacteristics?: 'COLOR_TRANSFER_CHARACTERISTICS_UNKNOWN' | 'COLOR_TRANSFER_CHARACTERISTICS_BT709' | 'COLOR_TRANSFER_CHARACTERISTICS_UNSPECIFIED' | 'COLOR_TRANSFER_CHARACTERISTICS_BT2020_10' | 'COLOR_TRANSFER_CHARACTERISTICS_SMPTEST2084' | 'COLOR_TRANSFER_CHARACTERISTICS_ARIB_STD_B67';
};
...
type IYoutubeApiInnertubeOnesiePlayerServiceInfo = {
    drmProduct?: 'DRM_PRODUCT_UNKNOWN' | 'DRM_PRODUCT_UGC' | 'DRM_PRODUCT_TVOD' | 'DRM_PRODUCT_AVOD' | 'DRM_PRODUCT_YOUTUBE_TV' | 'DRM_PRODUCT_PREMIUM_LIVE' | 'DRM_PRODUCT_ALC';
...
type IYoutubeApiInnertubeStreamableVideo = {
    ...
    latencyClass?: 'MDE_STREAM_OPTIMIZATIONS_RENDERER_LATENCY_UNKNOWN' | 'MDE_STREAM_OPTIMIZATIONS_RENDERER_LATENCY_NORMAL' | 'MDE_STREAM_OPTIMIZATIONS_RENDERER_LATENCY_LOW' | 'MDE_STREAM_OPTIMIZATIONS_RENDERER_LATENCY_ULTRA_LOW';
    liveChunkReadahead?: number;
    livePlaybackType?: 'LIVE_PLAYBACK_TYPE_UNKNOWN' | 'LIVE_PLAYBACK_TYPE_LIVE' | 'LIVE_PLAYBACK_TYPE_DVR' | 'LIVE_PLAYBACK_TYPE_LP' | 'LIVE_PLAYBACK_TYPE_POST' | 'LIVE_PLAYBACK_TYPE_WINDOW';
    ...
    streamableVideoType?: 'STREAMABLE_VIDEO_TYPE_UNKNOWN' | 'STREAMABLE_VIDEO_TYPE_REQUESTED' | 'STREAMABLE_VIDEO_TYPE_PREROLL';
...
type IYoutubeApiInnertubeContentVideoUstreamerContext = {
    ...
    responseType?: 'STREAMING_WATCH_RESPONSE_TYPE_UNKNOWN' | 'STREAMING_WATCH_RESPONSE_TYPE_PLAYER_RESPONSE' | 'STREAMING_WATCH_RESPONSE_TYPE_WATCH_NEXT_RESPONSE' | 'STREAMING_WATCH_RESPONSE_TYPE_AD_WATCH_NEXT_RESPONSE' | 'STREAMING_WATCH_RESPONSE_TYPE_INCREMENTAL_WATCH_NEXT_RESPONSE' | 'STREAMING_WATCH_RESPONSE_TYPE_ONESIE_EARLY_CONTENT_VIDEO_INFO' | 'STREAMING_WATCH_RESPONSE_TYPE_ONESIE_EARLY_PREROLL_AD_VIDEO_INFO' | 'STREAMING_WATCH_RESPONSE_TYPE_REEL_WATCH_PAGE_RESPONSE';
...
type IYoutubeApiInnertubeChallengePrompt = {
    ctx?: string;
    plt?: string;
    type?: 'CHALLENGE_PROMPT_TYPE_UNSPECIFIED' | 'CHALLENGE_PROMPT_TYPE_AUTHENTICATE';
};
...
type IYoutubeApiInnertubeWebResponseContextExtensionData = {
    ...
    pageTheme?: 'UNSPECIFIED' | 'RED_ORIGINALS_HOME' | 'RED' | 'MEMBERSHIPS_AND_PURCHASES' | 'YPC_OFFERS';
...
export interface IRawHeartbeatParams {
    drmSessionId?: string;
...
export interface IRawResponse {
    ...
    entries?: RawNode[];
    heartbeatParams?: IRawHeartbeatParams;
    heartbeatServerData?: string;
    pollDelayMs?: string;
